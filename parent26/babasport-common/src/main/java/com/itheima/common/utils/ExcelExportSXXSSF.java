...
import com.itheima.common.testbean.Bean;
/**  
**********************************************
* @ClassName: ExcelExportSXXSSF  
* @Description:excel导出的封装类
* @author 代祯山 
* @date 2017年2月12日 下午3:53:48   
**********************************************
*/ 
public class ExcelExportSXXSSF {
	...
	public String exportFile() throws Exception {
		String filename = filePrefix+"_"+new SimpleDateFormat("yyyyMMddHHmmss").format(new Date()) + ".xlsx";
	...
	public static void main(String[] args) throws Exception {
		...
		fieldCodes.add("id");//药品流水号
		fieldCodes.add("name");//通用名
		...
		list.add(new Bean(1, "药品", 50));
		list.add(new Bean(2, "药品1", 50));
		list.add(new Bean(3, "药品2", 50));
		list.add(new Bean(4, "药品3", 50));
		//执行导出
