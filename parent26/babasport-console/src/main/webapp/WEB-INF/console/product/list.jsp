...
//上架
function isSale(name,brandId,isShow,pageNo){
	//请至少选择一个
	...
	//提交 Form表单
	$("#jvForm").attr("action","/product/isSale.do?name="+name
		+"&brandId="+brandId	
		+"&isShow="+isShow		
		+"&pageNo="+pageNo
	);
...
<div style="margin-top:15px;">
	...
	<input class="add" type="button" value="上架" onclick="isSale('${name}','${brandId }','${isShow }','${pagination.pageNo }');"/>
